<template>
  <div id="show-user">
    <h5>中国地图</h5>
    <div id="bar-wrap" :style="{width:'100%', height:'600px'}"></div>
  </div>
</template>
<script type="text/javascript">
  ...
  export default{
    ...
    mounted(){
      let that = this;
      that.myChart = echarts.init(document.getElementById('bar-wrap'))
      var geoCoordMap =  {
        '海门':[121.15,31.89],
      ...
      var data = [
        {
          ...
          name: '上海',
          value: Math.round(Math.random() * 39)
        }, {
          name: '重庆',
          value: Math.round(Math.random() * 49)
        }, {
          name: '河北',
          ...
          name: '新疆',
          value: Math.round(Math.random() * 35),
        }, {
          name: '江苏',
          value: Math.round(Math.random() * 100),
        }, {
        ...
        for (var i = 0; i < data.length; i++) {
          ...
          if (geoCoord) {
            res.push({
              ...
              onCount: data[i].onCount,
              offCount:data[i].offCount
            });
          }
        }
        return res;
      ...
      let option = {
        tooltip: { //提示框组件。
          ...
          formatter: function (params) {
            if (params.value[2]) {
              var r1 = '所在地区' + ':' + params.name + '<br>' + ' value' + ': ' + params.value[2]
              return r1
            }},
        },
        visualMap: {
